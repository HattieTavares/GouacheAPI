...
const brands = {    
    ...
    "Arteza" : [
        ...
        },
        {
            ...
            "name" : "Pearl Gray (previously Pearl Noir)",
            "rating" : "***",
            "pigments" : "Mica, PBK11",
            "opacity" : "Opaque",
            "hex" : "#9f9c9d",
    ...
    "Liquitex" : [
        ...
        {
            "number": "810",
            "name": "Light Portrait Pink",
            "rating": "II",
            "pigments": "PO73, PY74, Pw6",
            "opacity": "Opaque",
            "hex": "#fcbaab",
            "family": "Red",
            "addedWhite": true
        ...
        {
            "number": "660",
            "name": "Bright Aqua Green",
            "rating": "I",
            "pigments": "PB15:3, PG7, P",
            "opacity": "Opaque",
            "hex": "#00b8b0",
            "family": "Green",
            "addedWhite": true
        ...
        {
            "number": "224",
            "name": "Hooker's Green Hue Permanent",
            "rating": "I",
            "pigments": "PY83, PG7",
            "opacity": "Opaque",
            "hex": "#013328",
...
app.get("/api/:name", (request, response)=>{
    const brandName = request.params.name
    response.json(brands[brandName])
})
